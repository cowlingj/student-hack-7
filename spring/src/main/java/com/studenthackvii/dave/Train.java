...
public class Train {
    ...
    public void train() {
        ...
        FloatBuffer ones = FloatBuffer.wrap(new float[]{1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f});
        Tensor<Float> constants = Tensor.create(new long[]{10}, ones);

        g.opBuilder("Assign", "assign1")
                .addInput(g.opBuilder("Const", "c1")
                        .setAttr("dtype", DataType.FLOAT)
                        .setAttr("value", constants)
                        .build()
                        .output(0))
                .addInput(ratingsAddVar.output(0))
                .build();

        g.opBuilder("Assign", "assign2")
                .addInput(g.opBuilder("Const", "c2")
                        .setAttr("dtype", DataType.FLOAT)
                        .setAttr("value", constants)
                        .build()
                        .output(0))
        ...
        g.opBuilder("Assign", "assign3")
                .addInput(g.opBuilder("Const", "c3")
                        .setAttr("dtype", DataType.FLOAT)
                        .setAttr("value", constants)
                        .build()
                        .output(0))
        ...
        g.opBuilder("Assign", "assign4")
                .addInput(g.opBuilder("Const", "c4")
                        .setAttr("dtype", DataType.FLOAT)
                        .setAttr("value", constants)
                        .build()
                        .output(0))
